#!/usr/bin/env python3
"""Measure a thermocapillary drop's RISE velocity and compare it to the Young-Goldstein-Block
(YGB) speed, for both geometry modes of case.py (Samareh 2014, Sec. 4.1.1 / Figs 5-6).
...
# Samareh's converged 2D ratio (Fig 5). This example is 2D only.
samareh_ratio = 0.80
