...
print(
    f"VERIFY resolution: Pe~{Pe_:.0f}, thermal-layer delta~{delta_ * 1e3:.2f} mm vs cell dx~{dx_ * 1e3:.2f} mm "
    f"-> thermal layer resolved: {delta_ > dx_} (else the mu(T) MAGNITUDE is not grid-converged)"
)
