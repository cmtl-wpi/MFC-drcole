% 3D Gaussian hot spot -- case.py.
% Cube with adiabatic (zero-gradient) walls; a Gaussian blob at the center,
...
\begin{tikzpicture}[>=Stealth, font=\footnotesize, line cap=round]
  ...
  % front face frame = adiabatic walls
  \draw[inkc, line width=1.4pt] (0,0) rectangle (\S,\S);
  \node[inkc!75, anchor=south] at (\S/2,\S+0.06) {adiabatic (zero-gradient) walls};
