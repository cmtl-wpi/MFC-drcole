...
DESCRIPTIONS = {
    ...
    "amr_block_beg": "Refined-block start cell index per axis (level-0 index space)",
    "amr_block_end": "Refined-block end cell index per axis (level-0 index space)",
    "amr_l2_block_beg": "Level-2 block start cell index per axis, in level-1 FINE-cell index space (used only when amr_max_levels>=2; must nest strictly inside the level-1 block)",
    "amr_l2_block_end": "Level-2 block end cell index per axis, in level-1 FINE-cell index space (used only when amr_max_levels>=2; must nest strictly inside the level-1 block)",
    ...
    "amr_max_levels": "Number of AMR refinement levels (1 = single level over the base; 2 = a level-2 block nested in a level-1 block; default 1). >1 is experimental (static, lockstep, single-rank)",
