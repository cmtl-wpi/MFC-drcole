...
contains
    ...
    impure subroutine s_mpi_bcast_user_inputs
        ...
        #:for VAR in [ 'cyl_coord', 'mpp_lim', 'mixture_err',                     &
            ...
            & 'file_per_process', 'relax', 'cf_wrt', 'T_s_wrt', 'igr', 'liutex_wrt', &
            ...
            & 'surface_tension', 'thermal_scalar', 'hyperelasticity', 'bubbles_lagrange', &
        ...
        do i = 1, num_fluids_max
            ...
            call MPI_BCAST(fluid_pp(i)%visc_c, 1, mpi_p, 0, MPI_COMM_WORLD, ierr)
            call MPI_BCAST(fluid_pp(i)%visc_d, 1, mpi_p, 0, MPI_COMM_WORLD, ierr)
            call MPI_BCAST(fluid_pp(i)%visc_model, 1, MPI_INTEGER, 0, MPI_COMM_WORLD, ierr)
        end do
        ...
        #:for VAR in [ 'pref', 'rhoref', 'R0ref', 'poly_sigma', 'Web', 'Ca', &
            & 'Re_inv', 'Bx0', 'sigma', 'sigma_T_ref', 'sigma_dTdT', 't_save', 't_stop',      &
