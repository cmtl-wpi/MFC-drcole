...
| `sigma_model`              | Integer | Surface tension model: 0 constant, 1 linear in temperature, 2 linear in surfactant, 3 nonlinear (Langmuir) |
...
| `sigma_El`                 | Real    | Surfactant elasticity E in the nonlinear Langmuir closure (`sigma_model = 3`) |
| `surf_max`                 | Real    | Maximum surfactant packing Gamma_inf in the Langmuir closure (`sigma_model = 3`) |
